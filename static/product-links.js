...
globalThis.PRODUCT_CATALOG = {
  ...
  bed: {
    default: [
      { type: "돌돌이", name: "Scotch-Brite Lint Roller", purpose: "침구와 침대 주변의 머리카락·보풀을 가볍게 걷을 때 참고할 수 있어요.", caution: "패브릭은 강하게 문지르지 말고, 의류·침구의 세탁 표시를 먼저 확인하세요.", query: "Scotch-Brite Lint Roller", image: "https://m.media-amazon.com/images/I/71V3bY0OEaL._AC_SL1500_.jpg" },
      { type: "패브릭용 극세사 천", name: "Scotch-Brite Microfiber Cloth", purpose: "침대 주변의 마른 먼지를 가볍게 걷을 때 참고할 수 있어요.", caution: "패브릭은 물기나 강한 세정제를 바로 사용하지 말고 세탁 표시를 우선하세요.", query: "Scotch-Brite Microfiber Cloth", image: "https://m.media-amazon.com/images/I/81KgfQO5RGL._AC_SL1500_.jpg" },
    ],
  },
  fabric: [
